...
setenv TOTAL_TIME                    1.0e-05        # Maximum simulation time in seconds (def: 20 s)
...
setenv NSPECIES                       3 #5     # The number of different atom types (default: 2)
setenv ATOMIC_SYMBOLS					"Ni Co Cr" #"Ni Co Cr Fe Mn" #
...
setenv MIN_SIG_BARRIER                 0.01    # Max height of barrier and inv. barrier for an event to be considered inside a basin
