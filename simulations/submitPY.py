...
#         }
    ...
    for iphi in keyss:
            ...
            #---
                inums = lnums[ 1 ] - 1
                string[ inums ] = "\t7:\' -var buff 0.0 -var T %s -var rnd %%s -var P 0.0 -var nevery 100 -var ParseData 1 -var DataFile data_minimized.txt -var DumpFile dumpThermalized.xyz -var WriteData equilibrated.dat\'%%np.random.randint(1001,9999),\n
"%(temp)
