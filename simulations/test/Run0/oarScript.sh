...
EXEC_DIR=/home/kamran.karimi1/Project/git/vacancyDiffusion/simulations/test
...
mpirun --oversubscribe -np 3 -x PathEam='/home/kamran.karimi1/Project/git/lammps2nd/lammps/potentials' -x INC='/home/kamran.karimi1/Project/git/vacancyDiffusion/simulations/lmpScripts'  -x DataFile=Equilibrated_500.dat KMC.sh
